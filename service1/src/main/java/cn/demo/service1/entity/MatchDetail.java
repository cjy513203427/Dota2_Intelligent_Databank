package cn.demo.service1.entity;
...
public class MatchDetail {
    ...
    private String string_duration;
    ...
    public Boolean getPlayer_if_win() {
        return player_if_win;
    }

    public void setPlayer_if_win(Boolean player_if_win) {
        this.player_if_win = player_if_win;
    }

    public String getString_duration() {
        return string_duration;
    }

    public void setString_duration(String string_duration) {
        this.string_duration = string_duration;
    }
}
