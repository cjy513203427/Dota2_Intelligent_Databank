...
public class SteamAccount {
    ...
    private String string_lastlogoff;
    ...
    public String getString_lastlogoff() {
        return string_lastlogoff;
    }

    public void setString_lastlogoff(String string_lastlogoff) {
        this.string_lastlogoff = string_lastlogoff;
    }
}
